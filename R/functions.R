...
#     purrr::set_names(nm = fish_habitat_info$crossing_id) %>% ##pscis_model_combined_id changed for crossing_id
...
#     distinct(crossing_id, .keep_all = T) %>% ##there are duplicates we should get rid of
#     st_as_sf()
# }
